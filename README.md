...
This is the web UI for [`Yomo`](https://github.com/bytedance/deer-flow).

## Quick Start

### Prerequisites

- [`Yomo`](https://github.com/bytedance/deer-flow)
- Node.js (v22.14.0+)
...
Yomo Web UI uses `pnpm` as its package manager.
...
Yomo is built upon the foundation of these outstanding projects:
